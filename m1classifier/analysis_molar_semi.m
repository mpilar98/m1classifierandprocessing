...
% Support Vector Machine and Fisher's Linear Discriminant Classifier 
% Release 29-03-2024
% Main steps:
% 1.- Image orientation 
% 2.- Scale and measure
% 3.- Works on individual items (m1 Drawings and m1 Occlusal surfaces)
% 4.- Works on files containing a sample of images (tif,tiff,TIF)
...
while etapa<8
    etapa=menu('M1 molars images Biometry : Analysis',...
        ...
        '3.- Clasify LDC/Hf/SVM Occlusal surface',...
        '4.- Clasify LDC/Hf/SVM Drawing',...
        '5.- Clasify LOO drawings sample file',...
    ...
    switch etapa
        ...
        case 8
% % %       [Mdl,Mdl2]=build_models(filenames);
            clear
            close all
            workroot=cd;
            dirpath=cd;
