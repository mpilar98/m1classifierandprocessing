function k = miMENUvdm(xHeader,varargin)
% version 9-01-2022
%miMENUvdm   Generate a menu of choices for user input.
...
%movegui(menuFig,'west');%%%
movegui(menuFig,[w0/2-100 h0/2-100]);% w0/2 h0/3
% movegui(menuFig,[20 40]);% 100 100
% % % movegui(menuFig,[20 500]);% 100 100
%------------------------------------------------------------------------
