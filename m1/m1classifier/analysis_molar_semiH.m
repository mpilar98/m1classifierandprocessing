...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
while etapa<8
    etapa=menu('Biometrics with Molar Images: Analysis',...
        '1.- Orient images',...
        '2.- Calibrate / Measure',...
        '3.- Classify LDC/Hf Recorte',...
        '4.- Classify LDC/Hf Esquema',...
        '5.- Classify Hf LOO folder Esquemas',...
        '6.- Classify Hf LOO folder Recortes',...
