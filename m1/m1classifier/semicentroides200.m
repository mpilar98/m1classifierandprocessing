...
% confección fichero Semicentroides200.mat 
global dos 
...
axis([1 100 1 30]);
axis off
text(10,10,'Centroid file of the half-perimeters of the varieties created correctly','Color','b')
text(10,20,'200 semi-perimeter points')
hold off
