...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        while opc<9
            opc=miMENU('Gestión bases de datos (Semiperidentales200.mat)',...
                ...
                '6.- Borrar instancia en el fichero de variedades',...
                '7.- Eliminar toda una variedad',...
                '8.- Volver');
            switch opc
            case 1
             try
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                axis([0 200 0 300])
                axis off
                text(50,300,'Instancias en base de datos','Color','k')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                axis([0 200 0 100])
                axis off
                text(50,100,'Variedades reconocidas','Color','k')
...
%%%%%%%%%%%% fin seleccion       
            ...
            instancia = str2double(inputdlg('Instancia a suprimir:','Semiperidentales200',[1 40])); 
         ...
         %%%%%%%%%%%%%%% fin depuración
                case 7 
                    ...
                    n=size(X,1);
                    especie = inputdlg('Variedad a suprimir:','Semiperidentales200',[1 40]);
                    ...
                    X=X(1:quedan,:);
                    Y=Y(1:quedan,:);
                    confirmar=inputdlg('Confirmar borrado datos: S/N (Si/No)','Semiperidentales200',[1 40],{'N'});
                    if char(confirmar)==or('S','Si')
                        save('Semiperidentales200.mat','X','Y','origen','molar');
                    else
                    end
                case 8
