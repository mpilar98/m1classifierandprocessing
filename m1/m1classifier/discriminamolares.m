...
axis([1 600 1 600])
axis off
            text(20,600,' Hausdorff ( Similar specimens )','Color','r')
...
%%%%%%%%%%%%%%%%%%%% Totales y Resúmenes por variedad %%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                text(420,1,'items')
                text(20,560,'Afinity : ','Color','r')
                text(170,560,'% ','Color','r')
                text(250,560,'Afinity : ','Color','b')%%%
                text(400,560,'% ','Color','b')%%%
                text(500,560,'Afinity : ','Color','m')%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
        figure(cuatro)
         ...
         text(1,140,'Studied specimens','Color','r');
          text(20,140,'Similar specimens','Color','b');
...
title('Phylomorphometric relationships (Centroids / Average / pdist2 square euclidean)')
