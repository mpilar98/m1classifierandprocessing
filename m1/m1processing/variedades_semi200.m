...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        while opc<9
           opc=miMENU('Database Management (Semiperidentales200.mat)',...
            ...
            '6.- Delete instance in variety file',...
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%
               ...
               text(120, 300, ' peripheral points )', 'Color', 'k')
           %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                 for k1=1:floor(n/8)
                ...
                text(155,n-8*(k7-k6),origen(k7),'FontSize',8,'Color','blue','Interpreter','none')
                hold on
                end
                for k8=floor(7*n/8)+1:n
                text(175,n-8*(k8-k7),num2str(k8),'FontSize',8,'Color','blue')
                text(180,n-8*(k8-k7),origen(k8),'FontSize',8,'Color','blue','Interpreter','none')
                hold on
                end
                hold off 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
