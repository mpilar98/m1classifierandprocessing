    ...
    switch choice
        ...
        case 3
            ...
            try
                ...
                y(1:2)=0.0;
                [foto,dirpath]=uigetfile({'*.bmp;*.tif;*.tiff;*.prn;*.jpg;*.TIF'},'Select the image to measure');
        ...
        case 4
            cd(dirpath)
            try
           [foto,dirpath]=uigetfile({'*.bmp;*.tif;*.tiff;*.prn;*.jpg;*.TIF'},'Select the image to calibrate');
