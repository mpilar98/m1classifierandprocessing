...
%%% Menu principal
while choice<8 
    choice=miMENU('Medida de segmentos y definición densidad de muestreo',...
        '1.- Calibrado manual unidad mátrica',...
        '2.- Autocalibrado unidad métrica',...
        '3.- Medir imagen',...
        '4.- Calibrar imagen',...
        '5.- Calibrar carpeta',...
    ...
    switch choice
        ...
        case 3
            ...
            try
                ...
                while cond>0
                    ...
                    text(600,10,'Click botón izquierdo para nueva medida','Color','k')
                    hold off
        ...
        case 6
            ...
            while num<6
             num=miMENU('Selecciona´número puntos perimetrales :',...
                    '1.- 50',...
                    '2.- 100',...
                    '3.- 200',...
                    '4.- 300',...
