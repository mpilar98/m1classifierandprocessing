function k = masMENUvdm(xHeader,varargin)
% version 9-01-2022
%miMENU   Generate a menu of choices for user input.
...
% movegui(menuFig,'northeast');%%%
movegui(menuFig,[w0/2+100 h0/2]);% w0/2 h0/3
