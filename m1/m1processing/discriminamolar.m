...
text(30,20,clase,'Color','r','Interpreter','none')
text(10,30,'Haussdorff :','Color','b')
text(30,30,respuesta1{ih(1)},'Color','b','Interpreter','none') %Hausdorff a Variedades
text(10,40,'Procrustes :','Color','m')
text(30,40,variedad(ic(1)),'Color','m','Interpreter','none') % Procrustes a centroides
%%%%%%%%%%%%%%%%
...
text(40,200-10*k1,origen(ih(k1)),'Interpreter','none','Color','b')
end
for k2=1:numvar
...
for k3=1:itemsC
text(75,200-10*k3,variedad(ic(k3)),'Color','m','Interpreter','none')
end
for k4=1:itemsC
