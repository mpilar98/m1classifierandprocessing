...
In this repositorie you can find both apps: m1processing and m1classifier, their project (.prj), their installers, and all the code in the corresponding folders.
