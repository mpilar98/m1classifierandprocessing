% Recorte.m
% process m1 molars occlusal surfaces pictures
% Release August 2023
...
%%%%%%%%%
     ...
     factor=240;
            try
             cd(dirpath)
            [fichero,dirpath]=uigetfile({'*.bmp;*.tif;*.tiff;*.prn;*.TIF'},'Select occlusal surface picture'); 
...
plot(V(ind+stopabajo(1)+locsmin(1)),U(ind+stopabajo(1)+locsmin(1)),'m^')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
