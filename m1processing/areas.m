...
% topological study of the regions in the binary image.
%
global cuatro
%%%%%%%%%%%%%%% find regions %%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% select the eight largest area regions
for i=1:objetos
...
%%%%%%%%%%%%%%%%%% Adaptaative bucle
for k=1:7
BW4 = bwareafilt(imcomplement(imagen),k,'largest');% the regions of interest
